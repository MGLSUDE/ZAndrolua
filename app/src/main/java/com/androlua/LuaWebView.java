...
public class LuaWebView extends WebView implements LuaGcable {
    ...
    private String mDir = "/storage/emulated/0/";
    ...
    public void openFile(String dir) {
        if (open_dlg == null) {
            ...
            open_list.setVerticalScrollBarEnabled(false);
            open_dlg.setContentView(open_list);
            open_dlg.setOnCancelListener(new DialogInterface.OnCancelListener(){
                    @Override
                    public void onCancel(DialogInterface dialog) {
            ...
            open_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> p1, View p2, int p3, long p4) {
                        ...
                        if (mUploadMessageArray != null) {
                            mUploadMessageArray.onReceiveValue(new Uri[]{Uri.fromFile(f)});
                            open_dlg.dismiss();
                            mUploadMessageArray = null;
                        }

                        if (mUploadMessage != null) {
                            mUploadMessage.onReceiveValue(Uri.fromFile(f));
                            open_dlg.dismiss();
                            mUploadMessage = null;
                        }
					}
	...
	public class SimpleLuaWebChromeClient extends WebChromeClient {    
		EditText prompt_input_field = new EditText(mContext);
		private LuaWebView.LuaWebChromeClient mLuaWebChromeClient;
